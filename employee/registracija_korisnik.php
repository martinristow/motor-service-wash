...
if($_SERVER['REQUEST_METHOD'] == "POST"){
   ...
   $result = $stmt->execute();
    ...
    if($created){
        ...
        $_SESSION['message']['text'] = "Uspesno kreiravte akaunt";
...
<head>
    ...
    <link rel="stylesheet" href="../public/css/css_employee/registracija_style.css">
...
<body>
    <div class="registration-container">
        ...
        <div class="container">
            ...
            <br>
            <a href="employee/index.php" class="btn btn-primary">Врати се назад</a>
        </div>
    </div>
</body>
</html>
