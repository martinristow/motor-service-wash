...
// ako parametarot id ne e praten togas prati go na druga strana
if ($update_id === '') {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_update = "UPDATE appointments SET appointment_date = ? , status = ? WHERE appointments_id  = ?";
...
<head>
    ...
    <link rel="stylesheet" href="../public/css/css_admin/update_termini_style.css">
...
<body>
    ...
    if ($result && $result->num_rows > 0) {
        ...
        // otstrani gi kosite zagradi i drgni gi praznite mesta
